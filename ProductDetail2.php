...
<body>
    ...
    <main>
        <div class="container bg-light" style ="height:1000px">
            <div><h2 class="card-text; margin-top:100px"> Second Product Detail</h2></div><br>
              <div class="row">
                <div class="col" >
                 <img src="./Assets/Images/e.jpg" alt="..." class="img-thumbnail">
                 <div class="card-body">
                <h4 class="card-text">-Shirt</h4>
              </div>
                </div>
                <div class="col">
            ...
            <div>
               ...
               <b>Product Name:</b><p>Paris Polo</p><br>
               <b>Product Code:</b><p>BB2</p><br>
