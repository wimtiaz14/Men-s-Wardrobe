...
<body>
    ...
    <main>
        <div class="container bg-light" style ="height:1000px">
            <div><h2 class="card-text;"> First Product Detail</h2></div><br>
              <div class="row">
                <div class="col" >
                 <img src="./Assets/Images/d.jpg" alt="..." class="img-thumbnail">
                 <div class="card-body">
                <h4 class="card-text">-Slipper</h4>
              </div>
                </div>
                <div class="col">
            ...
            <div>
               ...
               <b>Product Name:</b><p>Slipper</p><br>
               <b>Product Code:</b><p>BB</p><br>
